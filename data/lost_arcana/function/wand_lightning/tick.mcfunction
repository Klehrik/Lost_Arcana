...
execute as @a if data entity @s Inventory[{Slot:-106b}].components."minecraft:custom_data".lost_arcana_wand_lightning run function lost_arcana:wand_lightning/charge_display