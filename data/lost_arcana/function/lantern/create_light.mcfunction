...
execute if data entity @s SelectedItem.components."minecraft:custom_data".lost_arcana_lantern_strong run fill ~ ~1 ~ ~ ~1 ~ light[level=12] replace #minecraft:air
execute if data entity @s Inventory[{Slot:-106b}].components."minecraft:custom_data".lost_arcana_lantern_strong run fill ~ ~1 ~ ~ ~1 ~ light[level=12] replace #minecraft:air
