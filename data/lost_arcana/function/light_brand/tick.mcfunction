...
execute as @a if data entity @s Inventory[{Slot:-106b}].components."minecraft:custom_data".lost_arcana_light_brand run function lost_arcana:light_brand/charge_display